...
Widget researchBuilder(BuildContext context, List<ResearchModel> researchDataList) {
  return Center(
...
Widget cardBuilder(ResearchModel singleData, BuildContext context, [bool mounted = true]) {
  return Padding(
